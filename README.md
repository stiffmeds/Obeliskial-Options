...
| **Clone 1**                         | loremaster  | true        | Which subclass should clone 1 be?                                                                                                                                          |
| **Clone 1 Name**                    | Clone       | false       | What should clone 1 be called?                                                                                                                                             |
| **Clone 2**                         | loremaster  | true        | Which subclass should clone 2 be?                                                                                                                                          |
| **Clone 2 Name**                    | Copy        | false       | What should clone 2 be called?                                                                                                                                             |
| **Clone 3**                         | loremaster  | true        | Which subclass should clone 3 be?                                                                                                                                          |
| **Clone 3 Name**                    | Counterfeit | false       | What should clone 3 be called?                                                                                                                                             |
| **Level Past 50**                   | true        | false       | Allows characters to be raised up to rank 500.                                                                                                                             |

Subclasses as at Necropolis of the Damned release: mercenary, sentinel, berserker, warden, ranger, assassin, archer, minstrel, elementalist, pyromancer, loremaster, warlock, cleric, priest, voodoowitch, prophet, bandit, paladin, fallen, queen, engineer, valkyrie, alchemist, deathknight, bloodmage, priestess.
